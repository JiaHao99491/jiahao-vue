...
const nr = _({
  ...
  gs = _({
    ...
    setup(e) {
      const t = e
      Oe('JiaHaoVueTabsComponentRegisterTab', (r) => {})(t.name)
      const n = Oe('JiaHaoVueTabsData', C({ activeTab: '' })),
  ...
  ar = _({
    ...
    setup(e) {
      ...
      xe('JiaHaoVueTabsComponentRegisterTab', o)
      const r = Ne(e, 'activeTab'),
        a = C(r.value)
      H(a, () => (r.value = a.value))
      const i = k(() => ({ activeTab: a.value }))
      xe('JiaHaoVueTabsData', i)
      const l = k(
...
const mr = { class: 'w-full join join-vertical' },
  Os = _({
    ...
    setup(e) {
      return xe('accordianId', vr()), (t, n) => (O(), D('div', mr, [F(t.$slots, 'default')]))
    }
  }),
...
const ba = { ...vt, body: '' },
  ...
  Ps = _({
    ...
    setup(e) {
      const t = e,
        n = k(() => t.size)
      xe('JiaHaoAvatarSize', n)
      const o = k(() => t.mask)
      xe('JiaHaoAvatarMask', o)
      const r = k(() => [
